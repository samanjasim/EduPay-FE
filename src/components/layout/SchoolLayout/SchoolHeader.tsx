import { LogOut, User, Menu, Sun, Moon, Globe, School } from 'lucide-react';
...
export function SchoolHeader({ schoolName }: SchoolHeaderProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        {/* School badge */}
        {schoolName && (
          <div className="hidden md:flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 dark:bg-emerald-500/10">
